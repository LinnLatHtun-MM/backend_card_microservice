...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(CardsAlreadyException.class)
    public ResponseEntity<ErrorResponseDto> handleCardsAlreadyException(
            CardsAlreadyException exception, WebRequest webRequest) {
